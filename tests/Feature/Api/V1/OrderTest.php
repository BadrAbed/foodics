...
class OrderTest extends TestCase
{
    ...
    public function test_it_can_create_an_order_for_multiple_products_and_ingredients()
    {
    ...
    public function test_it_returns_an_error_when_quantity_is_negative()
    {
        $product1 = Product::factory()->create();
        $orderData = [
            'products' => [
    ...
    public function test_it_returns_an_error_when_quantity_is_zero()
    {
        $product1 = Product::factory()->create();
        $orderData = [
            'products' => [
    ...
    public function test_it_returns_an_error_when_quantity_is_greater_than_maximum()
    {
        $product1 = Product::factory()->create();
        $orderData = [
            'products' => [
    ...
    public function test_it_returns_an_error_when_ingredient_stock_is_insufficient()
    {
        $product1 = Product::factory()->create();
    ...
    public function test_it_sends_email_when_product_ingredient_falls_below_50_percent_and_only_send_once()
    {
        Mail::fake();
    ...
    public function test_it_does_not_send_email_when_product_ingredient_is_above_50_percent()
    {
        Mail::fake();
